...
return Vue.component('PagePicker', {
  template: tpl,
  data: function(){
    return {
      year: '1984',
  ...
  mounted: function() {
    this.$nextTick(function() {
      var that=this, step = 0;
      setInterval(function() {
        that.numberSlot[0].defaultIndex = step++;
        if (step > that.numberSlot[0].values.length - 1) {
          step = 0;
        }
      }, 1000);
    });
